...
In order to do any kind of interaction you first need to create an SMPP [Session](https://godoc.org/github.com/dolnikov/smpp#Session). Session is the main carrier of the protocol and enforcer of the specification rules.
...
Detailed examples for SMPP client and server can be found in the [examples dir](https://github.com/dolnikov/smpp/tree/master/parser).

[GoDoc]: https://godoc.org/github.com/dolnikov/smpp
[GoDoc Badge]: https://godoc.org/github.com/dolnikov/smpp?status.svg
[GoReportCard]: https://goreportcard.com/report/github.com/dolnikov/smpp
[GoReportCard Badge]: https://goreportcard.com/badge/github.com/dolnikov/smpp
